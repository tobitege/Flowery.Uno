...
namespace Flowery.Uno.RuntimeTests.SkiaRunner
{
    [TestClass]
    public class Given_RuntimeTestsRunner
    {
        ...
        [TestMethod]
        public async Task When_Running_SkiaRuntimeTests_Succeeds()
        {
            ...
            var resultPath = Path.Combine(runDirectory, "runtime-tests-skia.xml");
