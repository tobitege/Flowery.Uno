...
| `Size` | `DaisySize` | `Medium` | Control size (ExtraSmall, Small, Medium, Large, ExtraLarge) |
| `AutoFitItems` | `bool` | `true` | Auto-calculate item widths to fit container (recommended) |
