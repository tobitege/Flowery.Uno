...
Flowery.Uno provides two approaches for responsive scaling based on window size:
...
- **Customize at startup** - Set preset overrides in `App.xaml.cs` before any UI loads
