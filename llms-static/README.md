...
This folder holds the **curated, hand-written** documentation for Flowery.Uno. Files here are the primary source for both the generated site (`docs/`) and the machine-readable `docs/llms.txt`.
